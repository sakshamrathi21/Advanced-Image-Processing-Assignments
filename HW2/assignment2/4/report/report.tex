...
\begin{solution}{Part (c)}
  ...
  Let us assume to the contrary that $A$ does not satisfy MNSP. This means that there exists a nonzero vector $v \in null(A)$ such that $||v_{S_1}||_1 \geq ||v_{\bar{S_1}}||_1$ for some set $S_1$ of size $s$. 
  ...
  \[
    ||x^\top||_1 = ||x_S + v_S||_1 + ||x_{\bar{S}} + v_{\bar{S}}||_1
  \]

  Since $S$ is the support set of $x$, we have $||x_{\bar{S}} + v_{\bar{S}}||_1 = ||v_{\bar{S}}||_1$. Also, $||x_S + v_S||$
