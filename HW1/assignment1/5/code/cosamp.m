function sparse_image_reconstruction_cosamp()
    N = 32;
    image_size = N * N;
    k_values = [5, 50, 200];
    ...
    for k = k_values
        ...
        imwrite(reshape(f, N, N), sprintf('../images/cosamp/Ground_Truth_k_%d.png', k));
        ...
        for idx = 1:length(m_values)
            ...
            imwrite(reshape(f_hat, N, N), ...
                sprintf('../images/cosamp/Reconstructed_k_%d_m_%d.png', k, m));
        end
        ...
        saveas(gcf, sprintf('../images/cosamp/RMSE_vs_m_k_%d.png', k));
        close;
    end
    ...
    for m = m_fixed
        ...
        saveas(gcf, sprintf('../images/cosamp/RMSE_vs_k_m_%d.png', m));
        close;
    end
end
...
function [Sest, iterations, error] = algo(Phi,u,K)
