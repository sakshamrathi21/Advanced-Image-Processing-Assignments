...
for i = 1:length(plot_k_idxs)
  for j = 1:length(m_values)
    ...
    imwrite(z, sprintf("../images/cosamp/Reconstructed_k_%d_m_%d.png", k_values(plot_k_idxs(i)), m_values(j)));
  end
end
...
for i = 1:length(plot_m_idxs)
  for j = 1:length(k_values)
    ...
    imwrite(z, sprintf("../images/cosamp/Reconstructed_k_%d_m_%d.png", k_values(j), m_values(plot_m_idxs(i))));
  end
end
